            ...
            <div class="col-lg-6 align-self-center">
              <div class="owl-carousel owl-banner">
                <div class="item header-text">
                  <h6>Welcome to TecnoSpace</h6>
                  <h2>Quienes <em>somos</em> <span>nosotros</span>?</h2>
                  <p>Somos una empresa de diseño digital que ofrece soluciones creativas y 
                    personalizadas para todo tipo de proyectos. Nuestro equipo está formado por profesionales apasionados
                     por el diseño, la tecnología y la innovación.</p>
                  <div class="down-buttons">
                    <div class="main-blue-button-hover">
                      <a href="#contact">Envíanos Un Mensaje Ahora</a>
                    </div>
                    <div class="call-button">
                      <a href="#"><i class="fa fa-phone"></i> 997-165-2862</a>
                    </div>
                  </div>
                </div>
                <div class="item header-text">
                  <h6>Online Marketing</h6>
                  <h2>Nuestros <em>Servicios</em> para <span>TI</span></h2>
                  <p>Nos especializamos en diseño web, diseño gráfico, branding, marketing digital y desarrollo de aplicaciones.
                     Nuestro objetivo es crear experiencias digitales únicas que conecten con tu público objetivo y potencien tu marca.</p>
                  <div class="down-buttons">
                    <div class="main-blue-button-hover">
                ...
                <div class="item header-text">
                  <h6>Contacto</h6>
                  <h2>Somos <em> TU </em> mejor <span>Opción</span></h2>
                  <p> Si quieres darle un impulso a tu negocio,  <a rel="nofollow" href="#contact"> contacta con nosotros</a>
                     y te asesoraremos sin compromiso. Estamos seguros de que podemos ayudarte a alcanzar tus objetivos. Somos la empresa de diseño digital que estabas buscando.</p>
                  <div class="down-buttons">
                    <div class="main-blue-button-hover">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="item first-item">
            <img class="tam" src="assets/images/LogoCirculo.png" >
            <h4>Paquete Social Beginner</h4><br>
            <h6>En este paquete sólo se contemplan los diseños</h6>
            <em>$750/mes</em>
            <span>$400 MXN</span>
            <ul>
              <li>5 Contenidos por Mes</li>
              <li>3 posts - Multiformato <br>(todas las redes)</li>
              <li> 2 historias - Instagram - FB - Tik Tok</li>
              <li>Asesoramiento en publicidad</li>
            </ul>
            <div class="main-blue-button-hover">
        ...
        <div class="col-lg-4">
          <div class="item second-item">
            <img class="tam" src="assets/images/LogoCirculo2.png" >
            <h4>Paquete Social Starter</h4>
            <br>
            <h6>En este paquete sólo se contemplan los diseños</h6>
            <em>$950/mes</em>
            <span>$650 MXN</span>
            <ul>
              <li>9 Contenidos por Mes</li>
              <li> 5 posts - Multiformato <br>(todas las redes)</li>
              <li> 2 historias - Instagram - FB - Tik Tok</li>
              <li>2 carruseles - Instagram - FB </li>
              <li>Asesoramiento en publicidad </li>
            </ul>
            <div class="main-blue-button-hover">
              <a href="#">Get it Now</a>
        ...
        <div class="col-lg-4">
          <div class="item third-item">
            <img class="tam" src="assets/images/LogoCirculo.png" >
            <h4>Cotiza a tu medida</h4>
            <br>
            <h6>Perfecto para compañías que 
              necesitan realizar publicaciones 
              específicas y promocionar una
               variedad de productos y/o servicios.</h6>
            <br>
            <span>Cotiza</span><h6>Mensual</h6>
            <ul>
              <li>Nuestra recomendación es 
                que inviertas al menos 
                $800 MXN en tu contenido
        ...
        <div class="col-lg-7">
          <div class="section-heading">
            ...
            <div id="map">
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14984.365137394654!2d-88.92769909845693!3d20.13023895085602!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f57302021b06877%3A0x7cb348354c0e2734!2sC.%2030%20113%2C%2097930%20Peto%2C%20Yuc.!5e0!3m2!1ses-419!2smx!4v1695139357276!5m2!1ses-419!2smx" width="100%" height="360" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div class="info">
              <span><i class="fa fa-phone"></i> <a href="#">997-165-2862</a></span>
              <span><i class="fa fa-envelope"></i> <a href="#">tecnospacedigital@gmail.com</a></span>
            </div>
          </div>
        </div>
        <div class="col-lg-5 align-self-center">
          <form id="contact" action="insertar.php" method="post">
            <div class="row">
              ...
              <div class="col-lg-12">
                <fieldset>
                  <input type="text" name="telefono" id="telefono" placeholder="Numero Telefono" required="">
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
                  <select name="Servicio_id" id="Servicio_id" required >
                    <option disabled value="">Seleccione uno</option>
                     ...
                     <?php 
                     include 'config.php';
                    $categoria = $con->query("SELECT * FROM servicios ");
                    while($row = $categoria->fetch_assoc()  ):
                    ?>
                    <option value="
                      <?php echo $row['nombre']; ?>"><?php echo $row['nombre']; ?></option>
                    <?php endwhile; ?>
                  </select>
              ...
              <div class="col-lg-12">
                <fieldset>
                  <input type="text" name="indicaciones" id="indicaciones" placeholder="Anexa detalles" >
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
                  <br>
                  <button type="submit" name="nuevo" id="nuevo" value="nuevo" class="main-button">Enviar</button>
                </fieldset>
              </div>
            </div>
          </form>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="about footer-item">
            ...
            <a href="#">tecnospacedigital@gmail.com</a>
            <ul>
        ...
        <div class="col-lg-12">
          <div class="copyright">
            <p>Copyright © 2023 TecnoSpace. All Rights Reserved. 
            <br>
          </p>
          </div>
        </div>
